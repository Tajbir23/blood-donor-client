...
const Organization = () => {
    ...
    const [orgType, setOrgType] = useState<string>("pending")
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <div className="flex mb-6 border-b">
                <button 
                    className={`px-4 py-2 font-medium ${orgType === 'pending' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
